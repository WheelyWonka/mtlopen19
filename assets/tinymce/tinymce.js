...
(function() {
  (function() {
    ...
    var insertCaretContainerNode = function(editor, caretContainer, formatNode) {
      var dom = editor.dom,
        block = dom.getParent(formatNode, $_fl2rax2ljkmcwkot.curry($_dli08w3ajkmcwktg.isTextBlock, editor));
      if (block && dom.isEmpty(block)) {
    ...
    function Quirks(editor) {
      ...
      var BACKSPACE = $_6bj5795wjkmcwlg6.BACKSPACE, DELETE = $_6bj5795wjkmcwlg6.DELETE, dom = editor.dom,
        selection = editor.selection, settings = editor.settings, parser = editor.parser;
